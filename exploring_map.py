...
def get_users(filename,_saveToFile=False):
	users = dict()
...
def get_addr_tags(filename,_saveToFile=False) :
	keys = dict()
...
if __name__ == "__main__":
	...
	if False :
		users = get_users(input_map_file,_saveToFile=False)
		_ = get_addr_tags(input_map_file,_saveToFile=False)
