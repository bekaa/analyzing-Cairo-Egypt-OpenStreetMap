...
OSM_PATH = config.cairo_cleared
DIR = config.CAIRO_CSV+"cairo_cleared/"
...
NODES_PATH            = DIR + "nodes.csv"
NODE_TAGS_PATH        = DIR + "nodes_tags.csv"
WAYS_PATH             = DIR + "ways.csv"
WAY_NODES_PATH        = DIR + "ways_nodes.csv"
WAY_TAGS_PATH         = DIR + "ways_tags.csv"
RELATIONS_PATH        = DIR + "relations.csv"
RELATION_MEMBERS_PATH = DIR + "relation_members.csv"
RELATION_TAGS_PATH    = DIR + "relation_tags.csv"
